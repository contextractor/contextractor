...
**Component**: htmlprocessing-server (HTML sanitization pipeline) - _not in this monorepo_
**Status**: Fixed
**Date**: 2026-01-16
...
_These paths reference the original `htmlprocessing-server` project, not this monorepo:_
